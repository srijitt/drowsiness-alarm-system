...
def notify():
    ...
    for _ in range(5):  # Play the notification 5 times
        ...
        time.sleep(30)  # Wait for 5 seconds before showing the notification again
...
def main():
    ...
    uploaded_file = st.file_uploader("Upload audio", type=["mp3","wav","mp4"])
